...
class OpenWeatherController {
    ...
    func fetchHourlyForecast(_ latitude: Double, _ longitude: Double) async throws -> HourlyForecast {
        ...
        components.queryItems = ["lat": String(latitude), "lon": String(longitude), "APPID":"245360e32e91a426865d3ab8daab5bf3", "units":"imperial", "exclude": "current,minutely,daily,alerts"].map { URLQueryItem(name: $0.key, value: $0.value)}
